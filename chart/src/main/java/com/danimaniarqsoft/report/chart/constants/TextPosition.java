package com.danimaniarqsoft.report.chart.constants;
...
public enum TextPosition {
	ALIGN_CENTER(CellStyle.ALIGN_CENTER), VERTICAL_BOTTOM(
			CellStyle.VERTICAL_BOTTOM), ALIGN_CENTER_SELECTION(
			CellStyle.ALIGN_CENTER_SELECTION), VERTICAL_CENTER(
			CellStyle.VERTICAL_CENTER), ALIGN_FILL(CellStyle.ALIGN_FILL), ALIGN_GENERAL(
			CellStyle.ALIGN_CENTER), VERTICAL_JUSTIFY(
