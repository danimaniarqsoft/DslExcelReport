...
public enum FontFormat {
	BOLD(Font.BOLDWEIGHT_BOLD), NORMAL(Font.BOLDWEIGHT_NORMAL), COLOR_RED(Font.COLOR_RED), COLOR_GREEN(
			(short) 17), COLOR_BLUE((short) 12), COLOR_BROWN((short) 16), COLOR_ORANGE((short) 53), COLOR_GRAY(
					(short) 23), COLOR_PINK((short) 6), COLOR_PURPLE((short) 20), COLOR_YELLOW((short) 51), COLOR_WHITE(
