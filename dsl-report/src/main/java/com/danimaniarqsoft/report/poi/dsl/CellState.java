...
public class CellState {
  ...
  public void createCell(Object value) {
    CellStyle cellStyle =
        PoiUtil.createCellStyle(context.getWorkbook(), defaultCellFormatContext());
  ...
  public CellState createCell(Object value, CellStyle cellStyle) {
    ...
    if (classTest == BigDecimal.class) {
      PoiUtil.createCell(context.getCurrentRow(), context.getNextColumnNum(), (BigDecimal) value,
          cellStyle);
    } else if (classTest == Double.class) {
      PoiUtil.createCell(context.getCurrentRow(), context.getNextColumnNum(), (Double) value,
          cellStyle);
    } else if (classTest == String.class) {
      PoiUtil.createCell(context.getCurrentRow(), context.getNextColumnNum(), (String) value,
          cellStyle);
      ...
      PoiUtil.createCell(context.getCurrentRow(), context.getNextColumnNum(), (Integer) value,
          cellStyle);
    }
    return this;
  }

  public CellState createDateCell(Date value, String dateFormat, CellStyle cellStyle) {
    PoiUtil.createDateCell(context.getCurrentRow(), context.getNextColumnNum(), value,
        context.getWorkbook(), dateFormat, cellStyle);
    return this;
  }

  public CellState createCellFormula(String formula) {
    PoiUtil.createCellFormula(context.getCurrentRow(), context.getNextColumnNum(), formula);
    return this;
  }
