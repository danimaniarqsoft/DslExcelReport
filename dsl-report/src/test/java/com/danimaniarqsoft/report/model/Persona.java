...
public class Persona {
  ...
  @ExcelColumn(name = "Persona",
      textPosition = {TextPosition.ALIGN_LEFT, TextPosition.VERTICAL_JUSTIFY},
      fontFormat = {FontFormat.STRIKEOUT, FontFormat.BOLD, FontFormat.COLOR_GREEN})
  ...
  @ExcelColumn(name = "Fecha", type = CellType.DATE, fontFormat = {FontFormat.BOLD,
      FontFormat.COLOR_RED, FontFormat.TIMES_NEW_ROMAN, FontFormat.COLOR_ORANGE},
